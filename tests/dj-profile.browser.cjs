...
(async()=>{
 ...
 assert.equal(saved.cover_avatar,3);assert.equal(saved.service_types[0],'Club');assert.equal(saved.soundcloud,'https://soundcloud.com/nova');assert.equal(saved.upcoming_events[0].name,'Hustle & Flow');
