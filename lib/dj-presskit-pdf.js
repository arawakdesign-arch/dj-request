...
function footer(doc, profileUrl) {
  ...
  doc.font('Helvetica-Bold').fontSize(7).fillColor('#fff').text(text(profileUrl, 90), 38, 806, { width: 340 });
  if (fs.existsSync(logoPath)) doc.image(logoPath, 416, 797, { fit: [28, 28] });
  doc.font('Helvetica-Bold').fontSize(7).fillColor('#fff').text('CRÉE TON PRESS KIT', 447, 806, { width: 110, align: 'right', characterSpacing: 0.8 });
}
